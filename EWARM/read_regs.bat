@echo off
REM Read DFSDM + GPIO registers from running STM32H747I-DISCO (CM7 core)
REM Connects via J-Link, reads memory, prints results, disconnects.
...
set MAC=C:\TouchGFXProjects\MyApplication\EWARM\read_dfsdm_regs.mac
...
echo.
echo Done. If you see FAIL lines above, the build has not been flashed yet.
pause
