...
void DMA2D_CopyBuffer(JPEG_Data_BufferTypeDef& job)
{
    /* Safety net: FrameBufferAddress==nullptr means decodeMJPEGFrame() has not
     * run yet.  Launching DMA2D with OMAR=0 causes an immediate TEIF crash. */
    if (FrameBufferAddress == nullptr)
    {
        return;
    }
